...
function App() {
  ...
  return (
    ...
    <div className="App">
       <div className='' > 
       <label class="block text-gray-500 font-bold " for="inline-full-name">FirstName: </label>
        ...
        <label class="block text-gray-500 font-bold " for="inline-full-name">LastName: </label>
